...
import * as RNFirebaseDatabase from "firebase/database";
...
export const dataBase = RNFirebaseDatabase.getDatabase(firebaseApp);
export const firebaseDatabase = RNFirebaseDatabase;
